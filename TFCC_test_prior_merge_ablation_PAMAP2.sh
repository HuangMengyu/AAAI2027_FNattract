...
srun --output="logs_prior_merge_ablation/test/PAMAP2_maxiter200/warmup1_prior${prior_delta_mode}_PAMAP2_%A_%a.out" \
python test.py \
    --dataset_name PAMAP2 \
    --baseline_checkpoint_path checkpoints_baseline_best/baseline_PAMAP2 \
    --checkpoint_path checkpoints/prior_merge_ablation/warmup1_maxiter200_prior${prior_delta_mode}_PAMAP2 \
