...
python -u FANTII_SP_extend_prior/main_5fold.py \
    ...
    --model_save_path FANTII_SP_extend_prior/checkpoints/gmm_100iter_concat_cosine_adaptivewarmup0.35_usehardnegdownweight_PAMAP2 \
    --batch_size 128 \
    --lr 1e-3 \
    --ssl True \
    --use_fn_mask False \
    ...
    --prior_save_dir FANTII_SP_extend_prior/prior_cache/PAMAP2_gmm_100iter_concat_cosine_adaptivewarmup \
