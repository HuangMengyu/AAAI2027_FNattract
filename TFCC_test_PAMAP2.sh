...
#SBATCH --output=logs_2modality/test/PAMAP2_%A.out
...
python test.py \
    ...
    --checkpoint_path checkpoints_baseline_best/gmm_100iter_concat_cosine_adaptivewarmup0.35_PAMAP2_current_best  \
