...
srun --output="logs_prior_merge_ablation/test/UCI-HAR_total/warmup1_prior${prior_delta_mode}_UCI-HAR_total_%A_%a.out" \
python test.py \
    --dataset_name UCI-HAR_total \
    --baseline_checkpoint_path checkpoints_baseline_best/baseline_UCI-HAR_total \
    --checkpoint_path checkpoints/prior_merge_ablation/warmup1_prior${prior_delta_mode}_UCI-HAR_total \
