...
#SBATCH --job-name=warmup_ablation_PAMAP2
#SBATCH --array=1-4

input_file='/mimer/NOBACKUP/groups/naiss2025-22-1224/AAAI2027/warm_epochs_ablation_PAMAP2.txt'
...
# For Testing:
srun --output="logs_warmup_ablation/PAMAP2_maxiter200/warmup${warm_epochs}_PAMAP2_%A_%a.out" \
...
python -u main_5fold.py \
    ...
    --model_save_path checkpoints/warmup_ablation/no_prior_maxiter200_warmup${warm_epochs}_PAMAP2 \
    --batch_size 128 \
    --lr 1e-3 \
    --ssl True \
    --use_prior True \
