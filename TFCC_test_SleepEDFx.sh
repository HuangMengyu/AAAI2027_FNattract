...
#SBATCH --output=logs_2modality/test/SleepEDFx_%A.out
...
python test.py \
    ...
    --checkpoint_path checkpoints_baseline_best/gmm_200iter_concat_cosine_adaptivewarmup0.35_SleepEDFx_current_best  \
