...
srun --output="logs_warmup_ablation/test/SleepEDFx_maxiter200/warmup${warm_epochs}_SleepEDFx_%A_%a.out" \
python test.py \
    --dataset_name SleepEDFx \
    --baseline_checkpoint_path checkpoints_baseline_best/baseline_SleepEDFx \
    --checkpoint_path checkpoints/warmup_ablation/maxiter200_warmup${warm_epochs}_SleepEDFx \
