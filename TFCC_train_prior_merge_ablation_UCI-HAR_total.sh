...
#SBATCH --job-name=prior_merge_ablation_UCI-HAR_total
#SBATCH --array=1-15

input_file='/mimer/NOBACKUP/groups/naiss2025-22-1224/AAAI2027/prior_merge_ablation_SleepEDFx_UCI-HAR_total.txt'
...
# For Testing:
srun --output="logs_prior_merge_ablation/UCI-HAR_total/warmup1_prior${prior_delta_mode}_UCI-HAR_total_%A_%a.out" \
...
python -u main_5fold.py \
    ...
    --epochs 10 \
    --warm_epochs 1 \
    --model_save_path checkpoints/prior_merge_ablation/warmup1_prior${prior_delta_mode}_UCI-HAR_total \
    --batch_size 128 \
    --lr 1e-3 \
    --ssl True \
    --use_prior True \
