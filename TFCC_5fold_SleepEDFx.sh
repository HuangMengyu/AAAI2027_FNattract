...
python -u main_5fold.py \
    ...
    --model_save_path checkpoints/gmm_200iter_concat_cosine_adaptivewarmup0.035_SleepEDFx \
    --batch_size 128 \
    --lr 1e-3 \
    --ssl True \
    --use_fn_mask False \
    ...
    --prior_save_dir prior_cache/SleepEDFx_gmm_200iter_concat_cosine_adaptivewarmup \
