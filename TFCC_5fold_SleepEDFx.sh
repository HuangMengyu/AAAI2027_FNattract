...
#SBATCH --array=1-5
#SBATCH --output=logs_4/SleepEDFx/gmm_200iter_concat_cosine_adaptivewarmup0.035_SleepEDFx_%A_%a.out
...
# For Testing:
python -u FANTII_SP_extend_prior/main_5fold.py \
    --dataset_name SleepEDFx \
    --current_num_fold ${SLURM_ARRAY_TASK_ID} \
    --epochs 10 \
    --warm_epochs adaptive \
    --adaptive_warmup_threshold 0.035 \
    --model_save_path FANTII_SP_extend_prior/checkpoints/gmm_200iter_concat_cosine_adaptivewarmup0.035_SleepEDFx \
    --batch_size 128 \
    --lr 1e-3 \
    --ssl True \
    --use_fn_mask False \
    ...
    --prior_save_dir FANTII_SP_extend_prior/prior_cache/SleepEDFx_gmm_200iter_concat_cosine_adaptivewarmup \
