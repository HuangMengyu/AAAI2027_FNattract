...
#SBATCH --job-name=binary_prior_ablation_UCI-HAR_total
#SBATCH --array=1-10

input_file='/mimer/NOBACKUP/groups/naiss2025-22-1224/AAAI2027/binary_prior_ablation_SleepEDFx_UCI-HAR_total.txt'
