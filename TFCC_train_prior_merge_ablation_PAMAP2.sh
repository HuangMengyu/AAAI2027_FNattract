...
#SBATCH --job-name=prior_merge_ablation_PAMAP2
#SBATCH --array=1-12

input_file='/mimer/NOBACKUP/groups/naiss2025-22-1224/AAAI2027/prior_merge_ablation_PAMAP2.txt'
...
# For Testing:
srun --output="logs_prior_merge_ablation/PAMAP2_maxiter200/warmup1_prior${prior_delta_mode}_PAMAP2_%A_%a.out" \
python -u main_5fold.py \
    --dataset_name PAMAP2 \
    --current_num_fold ${current_num_fold} \
    --epochs 10 \
    --warm_epochs 1 \
    --model_save_path checkpoints/prior_merge_ablation/warmup1_maxiter200_prior${prior_delta_mode}_PAMAP2 \
    --batch_size 128 \
    --lr 1e-3 \
    --ssl True \
    --use_prior True \
