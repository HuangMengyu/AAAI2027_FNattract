...
#SBATCH --output=logs_3modality/test_newseeds/PAMAP2_3_%A.out
...
python test.py \
    ...
    --baseline_checkpoint_path checkpoints_3modality/aaaa_with_most_seeds/new10seeds_baseline_PAMAP2_3 \
    --checkpoint_path checkpoints_3modality/aaaa_with_most_seeds/new10seeds_warmup1_iter200_PAMAP2_3