...
#SBATCH --output=logs_4/test/UCI-HAR_total_%A.out
...
python FANTII_SP_extend_prior/test.py \
    --dataset_name UCI-HAR_total \
    --baseline_checkpoint_path /mimer/NOBACKUP/groups/naiss2025-22-1224/KDD2026_TriAFNM/FANTII_SP_extend/checkpoints/baseline_UCI-HAR_total  \
    --checkpoint_path /mimer/NOBACKUP/groups/naiss2025-22-1224/KDD2026_TriAFNM/FANTII_SP_extend_prior/checkpoints/gmm_200iter_concat_cosine_adaptivewarmup0.35_usehardnegdownweight_UCI-HAR_total  \
