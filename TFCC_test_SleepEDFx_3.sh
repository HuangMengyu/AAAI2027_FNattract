...
#SBATCH --output=logs_3modality/test_newseeds/SleepEDFx_3_%A.out
...
python test.py \
    ...
    --baseline_checkpoint_path checkpoints_3modality/aaaa_with_most_seeds/new20seed_baseline_SleepEDFx_3 \
    --checkpoint_path checkpoints_3modality/aaaa_with_most_seeds/new20seed_warmup7_SleepEDFx_3